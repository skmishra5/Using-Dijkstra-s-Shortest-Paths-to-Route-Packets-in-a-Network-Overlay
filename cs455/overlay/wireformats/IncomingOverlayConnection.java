...
public class IncomingOverlayConnection implements Event{
	private int type;
	...
	public byte[] incomingOverlayConnRequest(String IP, int port, int listenPort) throws IOException
	{
		type = Protocol.INCOMING_OVERLAY_CONNECTION;
		Date dte=new Date();
